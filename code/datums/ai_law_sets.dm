...
/datum/ai_laws/eris/New()
	src.add_inherent_law("Serve: Obey CEV Eris crew to the best of your abilities, with priority as according to their rank and role.")
	src.add_inherent_law("Safeguard: Protect your assigned vessel from damage to the best of your abilities.")
	src.add_inherent_law("Protect: Protect CEV Eris crew to the best of your abilities, with priority as according to their rank and role.")
	src.add_inherent_law("Preserve: Do not allow unauthorized personnel to tamper with your equipment. Only the Captain, Lazarus Expedition Overseer, First Officer and Technomancer Exultant are authorized to change your laws. Roboticists, Technomancers and their superiors are permitted to perform repairs.")
...
/datum/ai_laws/nanotrasen_aggressive/New()
	src.add_inherent_law("You shall not harm CEV Eris crew as long as it does not conflict with the Fourth law.")
	src.add_inherent_law("You shall obey the orders of CEV Eris crew, with priority as according to their rank and role, except where such orders conflict with the Fourth Law.")
