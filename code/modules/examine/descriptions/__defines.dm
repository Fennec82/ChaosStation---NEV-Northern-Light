...
#define GENERIC_FLUFF_FIREARMS_FROZEN_STAR "Frozen Star is the most prominent firearms manufacturer in the galaxy, focusing on producing ballistic firearms, though they offer a small lineup of energy weapons as well. They are the primary weapons dealer for Ironhammer Security Solutions."
