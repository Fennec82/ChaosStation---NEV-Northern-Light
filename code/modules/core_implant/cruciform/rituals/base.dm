...
/datum/ritual/cruciform/base/reincarnation
	...
	desc = "A reunion of a spirit with its new body, ritual of activation of a crucifrom, lying on the body. The process requires Neotheology's special altar on which a body stripped of clothes is to be placed."
