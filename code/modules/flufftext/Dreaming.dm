...
var/list/dreams = list(
	"an ID card","a bottle","a familiar face","a crewmember","a toolbox","an Ironhammer operative","the captain",
	...
	"the Head of Personnel","the Ironhammer Commander","the Technomancer Exultant","a Moebius Expedition Overseer","a Moebius Biolab Officer",
	"the inspector","the gunnery sergeant","a member of the internal affairs","a technomancer","the janitor","atmospheric technician",
