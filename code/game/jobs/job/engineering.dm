...
//	alt_titles = list()
	...
	description = "You are the Technomancer Exultant, the head of the ship's maintenance crew. You and your crew work on the Eris, it is your work, and your pride. <br>\
...
/datum/job/technomancer
	...
	description = "You are a technomancer, member of a small clan of spacefaring technomancers. Maintaining the ship is your responsibility, ensure the engine is running, the lights are on, the thrusters are fueled, and the air is breathable<br>\
<br>\
...
The Eris is your home, your life, and your livelihood. Take pride in it, and in your responsibilities. You should be hesitant to abandon ship, and try your hardest to prevent that becoming necessary. The engineering department is your sovereign territory, and you should be very wary of outsiders entering uninvited. Your fellow technomancers are your family. Take care of them, treat them well, share everything with them, and solve your problems internally."
	...
	loyalties = "	As an engineer, your first loyalty is to your fellow technomancers. Ensure they are safe and well supplied, defend them, assist them, and share everything with them. If problems arise between you, ask the Technomancer Exultant to rule on it. Don't snitch on your fellow clanmates by calling Aegis. The Technomancer Exultant is the head of your clan, and in many ways a father figure. Trust in their wisdom and follow their instructions above anyone else's.<br>\
	<br>\
	Your second loyalty is to your ship. Unlike most of your crew, who would simply go home, the Eris IS your home. Avoid abandoning ship at all costs. This is where you live and it's worth sacrificing for. Take pride in your work, and make the Eris something to be cherished."
