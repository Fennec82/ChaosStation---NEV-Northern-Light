/datum/job/ihc
	...
	description = "You are the head of the Ironhammer Security division contracted to protect and serve aboard the CEV Eris. The company contracting you out, Ironhammer Security serves as both an internal security force, and as a guard for expeditions out with the ship.<br>\
	<br>\
