...
/datum/job/scientist
	...
	description = "You are a scientist, standing at the frontier of human advancement. Working for Moebius to find new research opportunities in deep space. The science wing is located in the second section, starboard side, opposite medical, and your medical colleagues should be fast friends. The medical wing is part of Moebius too, and so you fully share access with each other, and are free to use each others' supplies. (Just remember to ask first! They're probaly using it!)<br>\
<br>\
...
Explore, learn and adventure, do anything to advance the cause of knowledge"
	...
	Your second loyalty is to Moebius. In order to ensure it can continue its mission of research, it must remain profitable. Ensure its interests are farthered, and take care of your colleagues in both the research and medical wings"
...
<br>\
In addition, your department contains the manufacturing facilities for prosthetic limbs and enhancements. It typically also falls to you to install them too, and thus it is common for biomechanical technomancers to work in the robotics lab. This may or may not be in your character's skillset. If surgery isn't your specialty, you may defer the implementation to your colleagues over in Moebius Medical instead, and simply supply the parts for them to install.<br>\
<br>\
...
/datum/job/psychiatrist
	...
	spawn_positions = 1
	wage = WAGE_PROFESSIONAL
	supervisors = "the Moebius Biolab Officer"		//Eclipse edit.
	selection_color = "#bdb1bb"
