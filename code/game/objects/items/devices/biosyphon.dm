/obj/item/biosyphon
	...
	description_antag = "Ironhammer tends to fully trust any donut box thats put above the biospyhon. You could poison a box of donuts."
