/obj/item/device/spy_sensor
	...
	description_antag = "Be careful when placing spying sensors. On destruction, they will trigger an EMP around themselves. If left near any machinery, they could trigger alarms for Ironhammer detectives to investigate."
	var/active = FALSE
