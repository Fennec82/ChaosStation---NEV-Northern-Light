...
You are here to not only accomplish your assigned objectives, but also root out spies, saboteurs, and criminals within the church's ranks. Interrogate Church of Neotheology followers, and deal with those who would tarnish the public image of the church, or betray its principles.  <br> <br> \
