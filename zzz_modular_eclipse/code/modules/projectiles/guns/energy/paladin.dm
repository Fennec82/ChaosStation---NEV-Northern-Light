...
/obj/item/gun/energy/laser/paladin
	...
	desc = "The Neotheology Armory \"Paladin\" laser musket is a cheap, easily-produced firearm that is very popular among the frontier colonies the Children protect. It is best used with Neotheology disposable cells, but can load any standard M class power cell. The weapon fires a single powerful shot, overloading and destroying the cell when fired."
