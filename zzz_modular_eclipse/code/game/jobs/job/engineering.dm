...
/datum/job/technomancer/enforcer
	...
	description = "A loyal and hearty member of the Technomancer Corporation, a subsidiary of NanoTrasen, you are the bulwark that protects your fellow technomancers from the dangers aboard this ship that their tool belts and hardhats can't save them from.<br>\
