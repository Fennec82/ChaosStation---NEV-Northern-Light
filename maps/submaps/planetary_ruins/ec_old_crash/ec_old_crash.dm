...
/obj/item/paper/ecrashlog/Initialize()
	...
	We've lost the navigational suite from impacts, and are flying blind. We have tried every option, and our technomancers have ascertained that there is no way to repair it in the field.<br>
