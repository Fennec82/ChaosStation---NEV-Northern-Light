//Chaosstation ports start

//Vorestation ports start

/datum/sprite_accessory/tail/taur/mermaid/orcamermaid //No Ckey restrictions here
	name = "Mermaid Orca (Taur)"
	icon = 'zzz_modular_zchaosstation/icons/mob/vore/taurs_cs.dmi'
...
/datum/sprite_accessory/tail/taur/drake/extended
	...
	extra_overlay = "extended_fatdrake_markings2"

//Digitigrade legs
/* //Need fixes regarding extra_overlay2 and extra_overlay2_w vars
